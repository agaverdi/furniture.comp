                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-success" href="{{ route('backend.shipping.create') }}">Create</a>
                                @endif
                            </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning" href="{{ route('backend.shipping.edit', [$shipping->slug]) }}" ><i class="fas fa-edit">&nbsp;Edit</i></a>&nbsp;&nbsp;
                                            @endif
                                                @if(auth('admin')->user()->permissions->delete==4)
                                            <form action="{{ route('backend.shipping.destroy' ,$shipping->slug) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
