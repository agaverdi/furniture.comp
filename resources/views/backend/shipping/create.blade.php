                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Shipping Add</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <section class="content">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="inputName">Shipping State Name</label>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <input type="submit" value="Create new Shipping" class="btn btn-success float-right">
                    </div>
                </div>
            </section>
        <!-- /.content -->
