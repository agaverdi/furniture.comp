                        ...
                        <div class="card">
                            <div class="card-header">
                                @if(auth('admin')->user()->permissions->create==2)
                                    <a class="btn btn-success" href="{{ route('backend.category.create') }}">Create</a>
                                @endif
                            </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning" href="{{ route('backend.category.edit', [$category->slug]) }}" ><i class="fas fa-edit">&nbsp;Edit</i></a>&nbsp;&nbsp;
                                            @endif
                                            @if(auth('admin')->user()->permissions->delete==4)
                                                <form action="{{ route('backend.category.destroy' ,$category->slug) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
