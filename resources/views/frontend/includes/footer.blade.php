            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomsm">
                    ...
                    <div class="f-widget-about">
                        <div class="logo">
                            <a href="{{route('frontend.index')}}"><div style="width: 100px; height: 100px; float: left" >
                        ...
                        <p>Furniture sayt sadece developerin isini gostermek ucun nezerde tutulmusdur burda gorduyunuz her sey sadece goruntudur.
                            Kodlasdirma ucun nezerde tutulmus bu
                    ...
                    <div class="f-widget-news">
                        ...
                        <div class="news-articles">
                            <div class="news-column">
                                ...
                                <div class="txt-box">
                                    <p>Laboris nisi ut <a href="{{ route('frontend.index') }}">#Adil</a> aliquip econse- <br>quat. <a href="https://wa.me/+994509995597">https://wa.me/+994509995597</a></p>
                                </div>
                            </div>
                            ...
                            @foreach($categories as $category)
                                ...
                                @foreach($sub_categories as $sub_category)
                                    @if($sub_category->parent_category_id == $category->id)
                                        <li><a href="{{ route('frontend.product.index', ['level1' => $category->slug, 'level2' => $sub_category->slug]) }}">{{ $sub_category->category_name }}</a></li>
                                    @endif
                                @endforeach
                            @endforeach
                        </ul>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 text-right">
                    <!-- F Widget About of the Page -->
                    <div class="f-widget-about">
                        <h3 class="f-widget-heading">Məlumat</h3>
                        <ul class="list-unstyled address-list align-right">
                            <li><i class="fa fa-map-marker"></i><address>Baki şəhəri Yasamal rayonu <br>Albalı uşaq baxcası</address></li>
                            <li><i class="fa fa-phone"></i><a href="tel:994509995597">+994 (50) 999 55 97</a></li>
                            <li><i class="fa fa-envelope-o"></i><a href="mailto:adilagaverdiyev9@gmail.com">adilagaverdiyev9@gmail.com</a></li>
                        </ul>
                    </div>
                    <!-- F Widget About of the Page end -->
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>© <a href="{{ route('frontend.index') }}">Adil.</a> - All rights Reserved</p>
                </div>
                <div class="col-xs-12 col-sm-6 text-right">
                    <div class="bank-card">
                        <img src="../../frontend/images/bank-card.png" alt="bank-card">
                    </div>
                </div>
            </div>
        </div>
